                    ...
                    <div className="service-item justify-text">
                      ...
                      <div className="main-content text-start">
                        <h4 style={{ lineHeight: 1.3, color: "#001963" }}>
                          ...
                          >
                            Directrice bancaire et formatrice en finance,
                            management et IA appliquée
                          </span>
                        </h4>
                        ...
                        <p className="mt-4  justify-text">
                          ...
                          solide en gestion des crédits et des risques, suivi
                          des engagements et reporting avancé, pilotant des
                          équipes et plusieurs projets clés.
                        </p>
